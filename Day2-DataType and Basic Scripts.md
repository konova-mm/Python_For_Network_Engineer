...
#### ၅။ အောက်ပါ cmd နှစ်ခုမှ ဘုံပါဝင်နေသော vlan နံပတ်(intersection)ကို list အနေဖြင့် variable ထဲထည့်သွင်းပြီး ထုတ်ပြပါ။ ( vlan နံပတ်သာ ဖြစ်ရမည်၊ ['1', '3', '8'] ကဲ့သို့ ဖြစ်ရမည်။
```
cmd1 = "switchport trunk allowed vlan 1,2,3,5,8"
cmd2 = "switchport trunk allowed vlan 1,3,8,9"
```

#### ၆။ အောက်ဖော်ပြပါ ospf_route string အား ဒုတိယပုံစံကဲ့သို့ ဖြစ်အောင် ဖော်ပြပါ။
```
...
#### ၇။ mac string အား binary format string အဖြစ် ဖော်ပြပါ။ ( 101010101010101010111011101110111100110011001100)
```
mac = "AAAA:BBBB:CCCC"
```

#### ၈။ အောက်ဖော်ပြပါ ip string အား ဒုတိယပုံစံကဲ့သို့ ဖြစ်အောင် ဖော်ပြပါ။
```
ip = "192.168.3.1"
```
Answer be Like..
...
```
### Tasks (Task များအားလုံးအား သင်ထားပြီးသော သင်ခန်းစာများကိုသာ အသုံးချ ဖြေဆိုရမည်)
အောက်တွင် r1, r2, sw1 တို့အားပေးထားပါသည်။ user ထံမှ input တစ်ခု တောင်းပါ။ ထို input သည် r1 ဖြစ်လျှင် သူနဲ့ သက်ဆိုင်ရာကို ထုတ်ပြပေးရမည်။ r2, sw1 လည်းလျှင်လည်း သူနဲ့ သက်ဆိုင်ရာကို ထုတ်ပြပေးရမည်။ အဖြေသည် **if condition** မလိုပဲ ရနိုင်ပါသည်။
```
နမူနာ အဖြေ
$ python task_5_1.py
